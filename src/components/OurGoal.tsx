  ...
  return (
    <div className="container w-full mx-auto flex flex-col lg:flex-row gap-10 lg:gap-20 my-5 lg:my-16">
      <div className="w-full lg:w-1/2 pt-2 lg:pt-12 px-5 lg:px-0">
        <h1 className="flex flex-col lg:gap-3 text-2xl lg:text-5xl font-semibold font-primary text-white leading-10">
      ...
      <div className="w-full lg:w-1/2 bg-primary rounded-md p-5 lg:p-12">
